...
import 'package:baulog/screens/facility/facility_management_page.dart';
...
class Routes {
  ...
  static Map<String, WidgetBuilder> get buildRoutes {
    return {
      ...
      facilities: (BuildContext context) =>
          BaseLayout(page: FacilityManagementPage(), isAppBar: true),
    };
  }
